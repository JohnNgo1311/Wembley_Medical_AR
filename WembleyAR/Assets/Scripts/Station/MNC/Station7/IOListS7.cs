...
public class IOListS7 : MonoBehaviour
{
    ...
    //     {
    //         if (GlobalVariable.inputStation7[i]) inputCheck[i].SetActive(true);
    //         else inputCheck[i].SetActive(false);
    //     }
    //     for (var i = 0; i < outputCheck.Length; i++)
    //     {
    //         if (GlobalVariable.outputStation7[i]) outputCheck[i].SetActive(true);
