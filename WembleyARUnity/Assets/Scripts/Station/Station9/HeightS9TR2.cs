...
public class HeightS9TR2 : MonoBehaviour
{
    ...
    {
        //get API
        offsetHeight = GlobalVariable.S9_offset_2;
        minHeight = GlobalVariable.S9_min_2;
        maxHeight = GlobalVariable.S9_max_2;
    ...
    void Update()
    {
        double measuredHeight = GlobalVariable.S9_measured_2;
        double currentHeight = GlobalVariable.S9_current_2;
