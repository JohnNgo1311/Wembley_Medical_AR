...
public class IOListS3 : MonoBehaviour
{
    ...
    public GameObject[] inputCheck = new GameObject[8];
    public GameObject[] outputCheck = new GameObject[9];
    ...
    void Update()
    {
        ...
        {
            if (GlobalVariable.inputStation3[i]) inputCheck[i].SetActive(true);
            else inputCheck[i].SetActive(false);
        }
        for (var i = 0; i < outputCheck.Length; i++)
        {
            if (GlobalVariable.outputStation3[i]) outputCheck[i].SetActive(true);
